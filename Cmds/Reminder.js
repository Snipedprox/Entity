...
$channelsendmessage[$findchannel[$message[1];no];<@$authorid>{author:Reminder!:$useravatar[$clientid]}{title:A reminder made by you $message[2] ago has ended!}{url:https#COLON#//discord.com/channels/$guildid/$channelid/$messageid}{description:\`\`\`$messageslice[2]\`\`\`}{color:RANDOM}{timestamp}{footer:Reminder of $usertag | ID#COLON# $randomstring[5]}{thumbnail:https://cdn.discordapp.com/emojis/894330233526833152.png?size=128};no]
$wait[$message[2]]
